...
<font color="#55b748">Step 1:</font> Open `2023_asa-data-viz.Rproj`.
...
<font color="#55b748">Step 3:</font> Remove `color = "green"` from `aes()` and add it inside of `geom_point()` but outside of `aes()`. Run the code.
...
<font color="#55b748">Step 2:</font> Add `theme_minimal()` to the end of the code. 
