...
* Senior Data Scientist at the [Urban Institute](https://www.urban.org/)
...
<font color="#55b748">Step 1:</font> Open RStudio by double-clicking `2023_asa-data-viz.Rproj`

<font color="#55b748">Step 2:</font> Open `02_workbook.Rmd` in RStudio. Make sure it is in `2023_asa-data-viz.Rproj`. That is, you should not see `Project: (None)` in the top right of RStudio.
